import type { Chain, Client, FetchBalanceArgs, FetchTokenArgs, FetchTransactionArgs, GetContractArgs, PrepareSendTransactionArgs, PrepareWriteContractConfig, ReadContractConfig, SendTransactionArgs, SignTypedDataArgs, WaitForTransactionArgs, WatchReadContractResult, WriteContractArgs } from '@wagmi/core';
export declare type EthereumClient = Client<any, any>;
